      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="group relative bg-primary text-surface p-8 rounded-lg flex flex-col justify-between overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="font-body-base text-on-primary-container">Use code: 3FT20</p>
          </div>
        ...
        <div className="group relative bg-surface p-4 rounded-lg flex flex-col gap-4">
          ...
          <div className="space-y-2">
            ...
            <p className="font-body-base text-on-surface-variant">The essentials for every modular wardrobe. Curated by the 3FT team.</p>
